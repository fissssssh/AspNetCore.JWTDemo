...
namespace AspNetCore.JWTDemo.Migrator
{
    public class DbInitializer
    {
        ...
        public async Task InitAsync()
        {
            ...
            var permissions = Enum.GetValues(typeof(Resource)).Cast<Resource>().Where(r => !adminPermissions.Any(p => p.Type == $"Permission.{r}")).ToDictionary(x => x, x => ResourceOperation.ReadWrite);
